...
class PromptGen:
    ...
    def _template_to_string(self, template: str, vars_dict: Optional[Dict[str, str]] = None) -> str:
        """
    ...
    def to_sys_prompt(self) -> str:
        ...
        # 添加Output Structure
        output_structure_str = json.dumps(self.Output_structure, indent=2, ensure_ascii=False)
    ...
    def to_task_prompt(self, task_specific: str, example: Optional[str] = None, 
                      evaluate_vars: Optional[Dict[str, str]] = None) -> str:
        """
        构建任务提示模板（线程安全版本）
        """
        parts = []
