...
class _AppModel:
    def __init__(self):
        ...
        self.storage = ExpiringDictStorage(
            filename=self.storage_file_path, 
            expiry_days=7
        )
    ...
    def getTranslationContext(self, file_list: str = "", doc_folder: str = "", 
                            reserved_word: str = "", disclaimers: bool = False):
        """获取翻译上下文"""
...
def configure_app(api_key: str, base_url: str, model: str, target_language: str = "") -> None:
    """快速配置应用"""
...
def get_translation_context(file_list: str = "", doc_folder: str = "", 
                          reserved_word: str = "", disclaimers: bool = False):
    """获取翻译上下文"""
